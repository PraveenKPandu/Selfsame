...
| **JavaScript / TypeScript** | 🟢 alpha | conformance + end-to-end `verify`/`snapshot`/`drift` + agent JSON report; CommonJS **and ESM** capture (ESM needs Node ≥ 20.6); richer methods in progress. Lives in [`packages/node/`](../packages/node/) |
